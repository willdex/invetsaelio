...
<td width="10%" style="text-align: right;"><span style="font-weight: bold;"><img style="width: 100%" src="imagen/principal.png"></span></td></table>
      ...
      <table id=tabla_contenido style="font-size:12px">
          ...
          <tr id=tr_cabecera  >            
           ...
           <td colspan="8" align=center style=color:green>JERINGAS Y TUBERIAS</td>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-2008</td>
              <td colspan="4" align=center>Frasco Nalgene</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center>SV-1110</td>
              <td colspan="4"  align=center>Tubería Teflon</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-2002</td>
              <td colspan="4" align=center>Ensamblaje de Boquilla</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center>5600</td>
           <td colspan="8" align=center style=color:green>COMPRESORA</td>
              
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-1030</td>
              <td colspan="4" align=center>Acopladora 90°</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Motor</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-933</td>
              <td colspan="4" align=center>Acopladora TEE</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Manometro</td>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-936</td>
              <td colspan="4" align=center>Boquilla</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Regulador de Aire</td>
 ...
 <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-611</td>
              <td colspan="4" align=center>Sostenedor de Boquilla</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Tanque Compresora</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-608</td>
              <td colspan="4" align=center>Clamp. Adhesivo de 1/4</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Rudas</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  align=center>SV-609</td>
              <td colspan="4" align=center>Logo de Spravac</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Cables Electricos</td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
...
<tr  style=background-color:#E7F3EB>
              <td  align=center>SV-605</td>
              <td colspan="4" align=center>Cortinas</td>
               <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Válvula de Purgar</td>
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

<tr  style=background-color:#E7F3EB>
              <td  align=center>SV-606</td>
              <td colspan="4" align=center>Varillas</td>
                <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center></td>
              <td colspan="4"  align=center>Mangueras</td>
            <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>
 ...
 <br><br><br> <table id=tabla_contenido2 style="font-size:12px">
          ...
          <tr id=tr_cabecera  >            
           ...
           <tr  style="background-color: #4CAF50" >
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Nivelación de la Máquina</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Retiro de Cajas</td>  
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Activación de Foski</td>  
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Boquillas</td>  
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Disperción de Solución Vacunal</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
   ...
   <br><table id=tabla_contenido style="font-size:12px">
          ...
          <tr id=tr_cabecera  >            
           ...
           <tr  style="background-color: #4CAF50" >
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Enjuague de Tuberías</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Esterilizado de Tuberías</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Esterilizado de Boquillas</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
