...
<td width="80%" align="center" text-shadow: "2px 2px 4px #000000;"> <span style="font-size:25pt;"  color="#5c59a0" >INFORME DE MANTENIMIENTO (Zootec)</td>
...
<td width="10%" style="text-align: right;"><span style="font-weight: bold;"><img style="width: 100%" src="imagen/principal.png"></span></td></table>
  ...
  <br><br>  <br>';
   ...
   $html.='<main>
      <table  cellPadding="60" class="inspeccion">
          ...
          <tr>            
           ...
           <tr  style="background-color: #4CAF50" class="inspeccion">
              ...
              <th  text-rotate="55" style="color: white"  >Bueno</th>
              <th text-rotate="55" style="color: white">Malo</th>
              <th  style="color: white">Código Sistema</th>
         ...
         <th id="inspeccion_th"  colspan="5" style="color: black" align=center>Gabinete</th>  
          <th id="inspeccion_th"  colspan="5" style="color: black" align=center>Neomatica</th>

        </tr>



           <tr  style=background-color:#E7F3EB class="inspeccion">
            <td ></td>
            <td >ZT50</td>
            <td  width="200" >Plato Divisor del Medio del Gabinete</td>
            <td><input type="checkbox" class="checkbox" checked="yes"></input></td>
            ...
            <tr  style=background-color:#E7F3EB >            <td></td>
            <td>ZT51M-ZT51D</td>
          ...
          <tr style=background-color:#E7F3EB id="inspeccion_tr">
            <td></td>
            <td>ZT53S-ZT53DNS</td>
        ...
        <tr style=background-color:#E7F3EB>
            <td></td>
            <td></td>
            <td  width="200" style=color:#4CAF50 ><span style="font-weight: bold">PLATO DE COLOCACIÓN</span></td>
            <td></td>
            <td></td>
            <td >RPTO-00469</td>
            <td>ZT11</td>
...
<!--123123!-->
 ...
 <tr style=background-color:#E7F3EB>
  ...
  <tr style=background-color:#E7F3EB>
            <td></td>
            <td></td>
            <td  width="200"  style=color:#4CAF50 ><span style="font-weight: bold">JERINGAS/TUBERÍAS</span></td>
            <td></td>
            <td></td>
            <td ></td>
            <td>ZT357</td>
...
<tr style=background-color:#E7F3EB>
            <td></td>
            <td></td>
            <td  width="200"  style=color:#4CAF50 ><span style="font-weight: bold">NEUMÁTICA</span></td>
            <td></td>
            <td></td>
            <td >RPTO-00348</td>
            <td>ZT21B</td>
 ...
 $html.='<br><b>Observaciones:</b><br><br><br>';
 $html.='<br><b>Piezas Cambiadas:</b><br><br><br><br>';
   ...
   <br><table id=tabla_contenido style="font-size:12px">
          ...
          <tr id=tr_cabecera  >            
           ...
           <tr  style="background-color: #4CAF50" >
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Limpieza Plato Colocación</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
              ...
              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Esterilizado de Jeringa</td>  
              <td  align=center><input type="checkbox" checked></td>
              <td  align=center><input type="checkbox" checked="yes"></td>
            </tr>

              <tr  style=background-color:#E7F3EB>
              <td  style="color: black" align=center>Limpieza Módulo Inyector</td>  
              <td  align=center><input type="checkbox" checked="yes"></td>
              <td  align=center><input type="checkbox" checked></td>
            </tr>
...
$html.="<br><br><br><br><br><table id=tabla_firmajefe>
